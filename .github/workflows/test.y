  ...
  build:
    ...
    strategy:
      ...
      matrix:
        include:
          - userName: M-LTV
            repoName: TVBox-suanjinTVBox-suanjin
            branchName: main
    ...
    steps:
      ...
      - name: Check New Commit
        run: |
          upStream=https://github.com/M-LTV/TVBox-suanjin
          echo "upStream=$upStream" >> $GITHUB_ENV
          commit=$(curl -sL $upStream/commits/main |grep -o "/M-LTV/TVBox-suanjin/commit/[a-z0-9]\+" |head -1 | cut -d\/ -f5)
